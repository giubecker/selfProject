...
export const Home = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:9002/reserved/1").then((response) => {
    ...
    <>
      ...
      <div className="container">
        ...
        <div className="home">
          ...
          <span className="title">Progresso no protocolo</span><br/>
          <div className="row progress-home">
                <ProgressBar animated now={home.generalProgress} label={`${home.generalProgress}/300`} />
              </div>
          <span className="title">Perda de peso</span><br/>
          <div className=" row progress-home">
                <ProgressBar animated now={home.weightLoss} label={`50%`} />
              </div>
          <span className="title">Próxima consulta</span><br/>
          <Link to="/scheduling">
          ...
          <div className="home-card">{home.AchievementTitle}
          {(() => {
              ...
              <Link key={notification.id} to={`${notification.link}`}>
                <div className="home-card">
                  <div className="row notification0">
                    ...
                    <div className="column notification2"><h5>{notification.note}</h5></div>
                  </div>
                </div>
              </Link>
            ))}
